...
- [4.哈希表](#4dot哈希表)
  - [4.1.哈希表](#4dot1哈希表)
  - [4.2.实战题目](#4dot2实战题目)
    - [4.2.1.leedcode题目: 242.有效的字母异位词](#4dot21leedcode题目-242有效的字母异位词httpsleetcode-cncomproblemsvalid-anagramdescription)
    - [4.2.2.leedcode题目: 49.字母异位词分组](#4dot22leedcode题目-49字母异位词分组httpsleetcode-cncomproblemsgroup-anagrams)
    - [4.2.3.leedcode题目: 1.两数之和](#4dot23leedcode题目-1两数之和httpsleetcode-cncomproblemstwo-sumdescription)
- [5.树、二叉树、二叉搜索树](#5dot树二叉树二叉搜索树)
  - [5.1.树（Tree）](#5dot1树tree)
    - [5.1.1.二叉树遍历Pre-order/In-order/Post-order](#5dot11二叉树遍历pre-orderin-orderpost-order)
    - [5.1.2.二叉搜索树(Binary Search Tree)](#5dot12二叉搜索树binary-search-tree)
  - [5.2.实战题目](#5dot2实战题目)
    - [5.2.1.leedccde题目：94.二叉树的中序遍历](#5dot21leedccde题目94二叉树的中序遍历httpsleetcode-cncomproblemsbinary-tree-inorder-traversal)
    - [5.2.2.leedcode题目：144.二叉树的前序遍历](#5dot22leedcode题目144二叉树的前序遍历httpsleetcode-cncomproblemsbinary-tree-preorder-traversal)
    - [5.2.4.leedcode题目：590.N叉树的后序遍历](#5dot24leedcode题目590n叉树的后序遍历httpsleetcode-cncomproblemsn-ary-tree-postorder-traversal)
    - [5.2.5.leedcode题目：589.N叉树的前序遍历](#5dot25leedcode题目589n叉树的前序遍历httpsleetcode-cncomproblemsn-ary-tree-preorder-traversalsubmissions)
- [6.堆 Heap 和二叉堆（Binary Heap）](#6dot堆-heap-和二叉堆binary-heap)
  - [6.1.堆 Heap](#6dot1堆-heap)
  - [6.2.二叉堆 Binary Heap](#6dot2二叉堆-binary-heap)
  - [6.2.实战题目](#6dot2实战题目)
    - [6.2.1.剑指offer：40.最小的k个数](#6dot21剑指offer40最小的k个数httpsleetcode-cncomproblemszui-xiao-de-kge-shu-lcof)
    - [6.2.2.leedcode题目：239.滑动窗口最大值](#6dot22leedcode题目239滑动窗口最大值httpsleetcode-cncomproblemssliding-window-maximum)
    - [6.2.3.leedcode题目：347.前k个高频元素](#6dot23leedcode题目347前k个高频元素httpsleetcode-cncomproblemstop-k-frequent-elements)
- [7.图的实现和特征](#7dot图的实现和特征)
  - [7.1.图的属性和分类](#7dot1图的属性和分类)
  - [7.2.基于图相关的算法](#7dot2基于图相关的算法)
